...
public class FilterDispatcher implements Filter {
    ...
    private final String ACCESS_DENIED = "accessdenied.jsp";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.length() > 0) {
                ...
                String role = (String) session.getAttribute("PERMISSION");
                if (role == null) {
//                    String message = "Please login first!";
                    if (url.equals("add.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("search.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("update.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("main.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("takequiz.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("accessdenied.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("invalid.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    } else if (url.equals("detail.jsp")) {
                        res.sendRedirect(LOGIN_PAGE);
                    }
